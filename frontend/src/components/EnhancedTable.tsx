              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{row.completed ? 'Completed' : 'Pending'}</TableCell>
                    <TableCell>{categories.find(c => c.id === row.categoryId)?.name || 'No Category'}</TableCell>
                    <TableCell align="right">{row.priority || 1}</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
